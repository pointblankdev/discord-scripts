...
//   const command = {
//     name: 'matches',
//     description: 'Get a list of recent Gather matches',
//     options: [
//       {
//         name: 'limit',
...
//       {
//         name: 'tournament',
//         description: 'Search for matches in a tournament by tournament ID',
//         type: 3,
//         required: false,
//       },
//     ],
...
test('create command', async () => {
  const command = {
    name: 'warzone',
    description: 'Search for your (or others) warzone stats!',
    options: [
      {
        name: 'limit',
        description: 'Number of matches shown - Max 10',
        type: 4,
        required: true,
      },
      {
        name: 'provider',
        description: 'Chose your identity provider',
        type: 3,
        required: true,
        choices: [
          {
      ...
      {
        name: 'playerid',
        description: 'Enter the player ID for your identity provider',
        type: 3,
        required: true,
      },
    ],
